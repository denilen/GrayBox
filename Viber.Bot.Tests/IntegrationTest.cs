...
namespace Viber.Bot.Tests
{
    ...
    public class IntegrationTest
    {
        ...
        private string _recipientContactName;
        ...
        public void Init()
        {
            ...
            _botName = config["UserName"];
            _recipientContactName = config["RecipientContactName"];
            _recipientContactPhone = config["RecipientContactPhone"];
        ...
        public async Task SendContactMessageAsyncTest()
        {
            var result = await _viberBotClient.SendContactMessageAsync(new ContactMessage
            {
                ...
                Contact = new Contact
                {
                    Name = _recipientContactName,
                    Phone = _recipientContactPhone
                }
            });
            return;
        }
